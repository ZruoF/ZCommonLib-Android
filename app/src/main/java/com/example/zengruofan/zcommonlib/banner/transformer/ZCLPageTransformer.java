...
public abstract class ZCLPageTransformer implements ViewPager.PageTransformer {
    ...
    public static ZCLPageTransformer getPageTransformer(TransitionEffect effect) {
        switch (effect) {
            case Default:
