...
public class ZCLViewPager extends ViewPager {
    private boolean mAllowUserScrollable = true;
    private AutoPlayDelegate mAutoPlayDelegate;

    public ZCLViewPager(Context context) {
        super(context);
    }

    public ZCLViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setPageChangeDuration(int duration) {
        try {
            ...
            scrollerField.set(this, new ZCLBannerScroller(getContext(), duration));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
